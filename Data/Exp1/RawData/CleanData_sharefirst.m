...
data1 = xlsread("Block1_ShFirst.xlsx");
data1t = readtable("Block1_ShFirst.xlsx");
data2 = xlsread("ShareFirst.xlsx");
data2t = readtable("ShareFirst.xlsx");
data3 = xlsread("AccSecond.xlsx");
data3t = readtable("AccSecond.xlsx");
...
stat = readtable("statementsTruthc1.xlsx");
