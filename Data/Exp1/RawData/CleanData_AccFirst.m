...
data1 = xlsread("Block1_AccFirst2.xlsx");
data1t = readtable("Block1_AccFirst2.xlsx");
data2 = xlsread("ShareSecond2.xlsx");
data2t = readtable("ShareSecond2.xlsx");
data3 = xlsread("AccFirst2.xlsx");
data3t = readtable("AccFirst2.xlsx");
...
writetable(Allresults,'Results_Rep_AccFirst2.xlsx')
writetable(Adata,'DataTrials_Rep_AccFirst2.xlsx');
