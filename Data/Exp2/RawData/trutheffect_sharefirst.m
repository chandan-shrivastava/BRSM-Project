...
data1 = xlsread("Block1_ShareFirst.xlsx");
data1t = readtable("Block1_ShareFirst.xlsx");
data2 = xlsread("ShareFirst.xlsx");
data2t = readtable("ShareFirst.xlsx");
data3 = xlsread("AccSec.xlsx");
data3t = readtable("AccSec.xlsx");
...
Adata=[data_2(:,12) data_2(:,30) data_2(:,36) data_2(:,31) data_2(:,37:38) data_3(:,31) data_3(:,40:41)];
...
for n=1:n_subj2
 ...
 nz=n*60;
   for k=ny:nz
       ...
       Allresults.ShareFirst1(n)=1;
       Adata.ShareFirst1(k)=1;
...
%writetable(Allresults,'Results_Rep_ShareFirst.xlsx')
%writetable(Adata,'DataTrials_Rep_ShareFirst.xlsx');
